 ...
 *
 * @param qusdAddress - The qUSD token address for QIE network
 * @param qusdName - The qUSD token name for QIE network
 * @returns The EVM chain config
 */
function getChainConfig(qusdAddress?: string, qusdName?: string) {
  return {
    base: {
    ...
    // QIE Network
    "eip155:1990": {
      usdcAddress: qusdAddress || "",
      usdcName: qusdName || "qUSD",
    },
  };
}
